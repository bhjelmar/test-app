...
Report bugs at https://github.com/bhjelmar/test-app/issues
...
https://github.com/bhjelmar/test-app/issues.
...
Ready to contribute? Here's how to set up `test-app` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `test-app` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/test-app.git
